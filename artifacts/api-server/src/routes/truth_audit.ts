...
const CAPABILITIES = [
  ...
  { id: "cap_019", category: "data", name: "Feature Engineering", claimed: true, implemented: "stub", tested: "none", exercisedLive: false, owner: "lib/features", lastVerified: Date.now() - 604800000, notes: "Placeholder, not wired" },
  ...
  { id: "cap_027", category: "ops", name: "RBAC / Access Control", claimed: true, implemented: "stub", tested: "none", exercisedLive: false, owner: "lib/auth", lastVerified: Date.now() - 864000000, notes: "Placeholder only" },
