...
export class AssumptionTracker extends EventEmitter {
  ...
  private _initializeMockBacktests(): void {
    // Mock Backtest A: Excellent (A Grade)
    this.mockBacktests.set('bt-001', {
      config: {
        feeModel: 'realistic_tiered',
        fees: 0.001,
        slippage: 1.2,
        slippageModel: 'volume_dependent',
        spreadBps: 1.5,
        latencyMs: 50,
        partialFillsEnabled: true,
        marketImpactEnabled: true,
        sessionHoursEnforced: true,
        haltSimulation: true,
        ...
        minTrades: 250,
        timePeriodYears: 5,
        riskFreeComparison: true,
        maxDrawdownCheck: true,
        positionSizingMatches: true,
        overnightGapsModeled: true,
        dividendAdjustment: true,
        commissionStructure: 'interactive_brokers',
      },
      results: {
        totalTrades: 280,
        timePeriodYears: 5,
    ...
    // Mock Backtest B: Good (B Grade)
    this.mockBacktests.set('bt-002', {
      config: {
        feeModel: 'fixed',
        fees: 0.002,
        slippage: 1.5,
        slippageModel: 'fixed_percent',
        spreadBps: 2.0,
        latencyMs: 100,
        partialFillsEnabled: true,
        marketImpactEnabled: true,
    ...
    // Mock Backtest C: Fair (C Grade)
    this.mockBacktests.set('bt-003', {
      config: {
        feeModel: 'fixed',
        fees: 0.0005,
        slippage: 0.5,
        ...
        lookAheadCheck: true,
        benchmarkComparison: 'IVV',
        minTrades: 120,
        timePeriodYears: 2,
        riskFreeComparison: false,
        maxDrawdownCheck: true,
        positionSizingMatches: true,
        overnightGapsModeled: false,
        dividendAdjustment: true,
        commissionStructure: 'coinbase',
      },
      results: {
        totalTrades: 145,
        timePeriodYears: 2,
    ...
    // Mock Backtest D: Poor (D Grade)
    this.mockBacktests.set('bt-004', {
      config: {
        feeModel: 'none',
        fees: 0,
        slippage: 0,
        ...
        partialFillsEnabled: false,
        marketImpactEnabled: false,
        sessionHoursEnforced: false,
        haltSimulation: false,
        survivorshipBiasControl: false,
        walkForwardEnabled: false,
        lookAheadCheck: false,
        benchmarkComparison: 'none',
        minTrades: 80,
        timePeriodYears: 1,
        riskFreeComparison: false,
        maxDrawdownCheck: false,
        positionSizingMatches: false,
        overnightGapsModeled: false,
        dividendAdjustment: false,
        commissionStructure: 'none',
      },
      results: {
        totalTrades: 95,
        timePeriodYears: 1,
    ...
    // Mock Backtest F: Unacceptable (F Grade)
    this.mockBacktests.set('bt-005', {
      config: {
        feeModel: 'none',
        fees: 0,
        slippage: 0,
