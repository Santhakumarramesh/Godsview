...
export class BrokerReconciler extends EventEmitter {
  ...
  private initializeMockData(): void {
    // Initialize internal orders
    this.internalOrders.set('ORD-001', {
      id: 'ORD-001',
      symbol: 'AAPL',
      side: 'BUY',
      qty: 100,
    ...
    this.internalOrders.set('ORD-002', {
      id: 'ORD-002',
      symbol: 'TSLA',
      side: 'SELL',
      qty: 50,
    ...
    this.internalOrders.set('ORD-003', {
      id: 'ORD-003',
      symbol: 'MSFT',
      side: 'BUY',
      qty: 75,
      ...
      updatedAt: Date.now() - 850000,
    });

    // Initialize broker orders (with some discrepancies)
    this.brokerOrders.set('ORD-001', {
      id: 'ORD-001',
      symbol: 'AAPL',
      side: 'BUY',
      qty: 100,
      filledQty: 100,
      avgFillPrice: 152.52, // Slight price difference
      status: 'FILLED',
      brokerTimestamp: Date.now() - 3400000,
    });

    this.brokerOrders.set('ORD-002', {
      id: 'ORD-002',
      symbol: 'TSLA',
      side: 'SELL',
      qty: 50,
      filledQty: 50, // Different filled qty
      avgFillPrice: 245.80,
      status: 'FILLED',
      brokerTimestamp: Date.now() - 1800000,
    });

    this.brokerOrders.set('ORD-004', {
      id: 'ORD-004',
      symbol: 'GOOGL',
      side: 'BUY',
      qty: 20,
      ...
      avgFillPrice: 142.30,
      status: 'FILLED',
      brokerTimestamp: Date.now() - 1200000,
    });

    // Initialize positions
    this.internalPositions.set('AAPL', {
      symbol: 'AAPL',
      qty: 100,
      avgCost: 152.50,
      marketValue: 15250,
    ...
    this.internalPositions.set('TSLA', {
      symbol: 'TSLA',
      qty: -30,
      avgCost: 245.75,
      marketValue: -7372.50,
    ...
    this.brokerPositions.set('GOOGL', {
      symbol: 'GOOGL',
      qty: 20,
      avgCost: 142.30,
      marketValue: 2846,
    ...
    // Initialize unsettled trades
    this.unsettledTrades.push({
      orderId: 'ORD-001',
      symbol: 'AAPL',
      qty: 100,
      filledPrice: 152.50,
      executedAt: Date.now() - 86400000,
      expectedSettlement: Date.now() + 86400000,
      settlementType: 'T+1',
      status: 'pending',
    });
