...
// Safe defaults for clean-clone boot. Fail-fast is reserved for production + live_enabled.
const DEFAULT_PORT = 3000;
const DEFAULT_DATA_DIR = "./.runtime";
const DEFAULT_SYSTEM_MODE: SystemMode = "paper";
...
function ensureDataDir(): string {
  ...
  if (raw) return raw;
  // Inject the default for any downstream module reading process.env.GODSVIEW_DATA_DIR.
