            ...
            <div className="bg-slate-900/50 border border-slate-700 rounded-lg p-6">
              ...
              <div className="space-y-2">
                {displayLevels.sort((a, b) => b.price - a.price).map((level) => {
                  const priceRange = Math.max(...displayLevels.map(l => l.price)) - Math.min(...displayLevels.map(l => l.price));
                  const priceOffset = ((level.price - Math.min(...displayLevels.map(l => l.price))) / priceRange) * 100;
