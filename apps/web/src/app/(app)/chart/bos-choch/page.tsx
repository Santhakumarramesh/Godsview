...
export default function BOSCHOCHEnginePage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      // Demo fallback data
      setEvents([
        { symbol: "AAPL", type: "BOS", direction: "bullish", priceLevel: 179.50, timeframe: "15min", timestamp: Date.now() },
        { symbol: "TSLA", type: "CHOCH", direction: "bearish", priceLevel: 244.20, timeframe: "15min", timestamp: Date.now() - 60000 },
        { symbol: "MSFT", type: "BOS", direction: "bullish", priceLevel: 378.75, timeframe: "15min", timestamp: Date.now() - 120000 },
        { symbol: "NVDA", type: "CHOCH", direction: "bullish", priceLevel: 892.50, timeframe: "15min", timestamp: Date.now() - 180000 },
      ]);
      setError("");
    } finally {
      setLoading(false);
