...
export default function LiquiditySweepMapperPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      // Demo fallback data
      setSweeps([
        { symbol: "AAPL", direction: "long", price: 179.50, trappedSide: "bearish", outcome: "reversal", timestamp: Date.now() },
        { symbol: "TSLA", direction: "short", price: 244.20, trappedSide: "bullish", outcome: "continuation", timestamp: Date.now() - 60000 },
        { symbol: "MSFT", direction: "long", price: 378.75, trappedSide: "bearish", outcome: "reversal", timestamp: Date.now() - 120000 },
      ]);
      setError("");
    } finally {
      setLoading(false);
