  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const [metricsData, tradesData] = await Promise.all([
        api.execution.getPerformanceMetrics(),
      ...
      setAutoTrades([
        { id: '1', symbol: 'AAPL', side: 'buy', qty: 100, entry_price: 175.50, current_price: 180.25, pnl: 475 },
        { id: '2', symbol: 'MSFT', side: 'sell', qty: 50, entry_price: 380.00, current_price: 378.75, pnl: 62.50 },
      ])
    } finally {
      setLoading(false)
    }
