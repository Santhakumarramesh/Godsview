    ...
    const fetchSentiment = async () => {
      try {
        ...
        const mockData: SentimentData[] = [
          { symbol: "AAPL", direction: "bull", confidence: 0.85, timestamp: new Date().toISOString() },
          { symbol: "TSLA", direction: "bear", confidence: 0.72, timestamp: new Date().toISOString() },
          { symbol: "MSFT", direction: "bull", confidence: 0.91, timestamp: new Date().toISOString() },
        ];
        setItems(mockData);
