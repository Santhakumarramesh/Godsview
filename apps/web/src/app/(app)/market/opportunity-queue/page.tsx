  ...
  useEffect(() => {
    const fetchSignals = async () => {
      try {
        ...
        const data = await api.scanner.getSignals({ symbols, timeframe: "15min" });
        ...
        const mockData: QueueItem[] = [
          { id: "1", symbol: "AAPL", direction: "bull", confluence_score: 85.5, signal_strength: 0.92, timestamp: new Date().toISOString(), status: "new" },
          { id: "2", symbol: "TSLA", direction: "bear", confluence_score: 72.3, signal_strength: 0.78, timestamp: new Date().toISOString(), status: "validated" },
          { id: "3", symbol: "MSFT", direction: "bull", confluence_score: 91.2, signal_strength: 0.95, timestamp: new Date().toISOString(), status: "pending" },
        ];
        setItems(mockData);
